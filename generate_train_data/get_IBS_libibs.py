...
from utils import geometry_utils, path_utils, log_utils, pyibs
...
class TrainDataGenerator:
    ...
    def get_ibs_mesh_o3d(self, geometries_path: dict):
        ...
        ibs = pyibs.IBS(np.asarray(pcd1.points), np.asarray(pcd2.points), bounded=False, clip="sphere")
        ibs_mesh_o3d = geometry_utils.trimesh2o3d(ibs.mesh)

        pcd1.paint_uniform_color((1, 0, 0))
        pcd2.paint_uniform_color((0, 1, 0))
        ibs_mesh_o3d.paint_uniform_color((0, 0, 1))
        o3d.visualization.draw_geometries([pcd1, pcd2, ibs_mesh_o3d], mesh_show_wireframe=True, mesh_show_back_face=True)
...
if __name__ == '__main__':
    config_filepath = 'configs/get_IBS_libibs.json'
