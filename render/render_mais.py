...
def create_materials():
    ...
    params = [
        ...
        {'name': 'mat', 'color': (0.243, 0.489, 0.794, 1.0), 'transparent': True}
    ]
...
def import_mat_sphere(mat_file):
    ...
    for i in range(10):
        ...
        center_ = center[i]
        radius_ = radius[i]
        sphere_name = 'Sphere' if i == 0 else 'Sphere.' + '%03d' % i
        sphere = bpy.data.objects[sphere_name]
        sphere.scale[0] = radius_
        sphere.scale[1] = radius_
        sphere.scale[2] = radius_
        sphere.location[0] = center_[0]
        sphere.location[1] = center_[2]
        sphere.location[2] = center_[1]
        sphere.active_material = bpy.data.materials['mat']
