...
from dataset import dataset_RBPCDC_single_norm
...
def get_evaluation_metrics(pcd_pred, pcd_gt, medial_axis_sphere):
    ...
    loss_dense_pcd1_path1 = cd_loss_L1(pcd1_pred_path1, pcd1_gt)
    loss_dense_pcd1_path2 = cd_loss_L1(pcd1_pred_path2, pcd1_gt)
    loss_dense_pcd2_path1 = cd_loss_L1(pcd2_pred_path1, pcd2_gt)
    loss_dense_pcd2_path2 = cd_loss_L1(pcd2_pred_path2, pcd2_gt)
    loss_dense = (loss_dense_pcd1_path1 + loss_dense_pcd1_path2 + loss_dense_pcd2_path1 + loss_dense_pcd2_path2) / 4

    loss_surface_pcd1_path1 = medial_axis_surface_loss(center1, radius1, pcd1_pred_path1)
    loss_surface_pcd1_path2 = medial_axis_surface_loss(center1, radius1, pcd1_pred_path2)
    loss_surface_pcd2_path1 = medial_axis_surface_loss(center2, radius2, pcd2_pred_path1)
    loss_surface_pcd2_path2 = medial_axis_surface_loss(center2, radius2, pcd2_pred_path2)
    ...
    loss_interaction_pcd1_path1 = medial_axis_interaction_loss(center1, radius1, pcd1_pred_path1)
    loss_interaction_pcd1_path2 = medial_axis_interaction_loss(center1, radius1, pcd1_pred_path2)
    loss_interaction_pcd2_path1 = medial_axis_interaction_loss(center2, radius2, pcd2_pred_path1)
    loss_interaction_pcd2_path2 = medial_axis_interaction_loss(center2, radius2, pcd2_pred_path2)
...
def train(network, train_dataloader, optimizer, epoch, specs, tensorboard_writer):
    ...
    for data, idx in train_dataloader:
        pcd_partial, pcd_gt, medial_axis_sphere = data
        ...
        loss_consistency = cd_loss_L1(pcd1_pred_path1, pcd1_pred_path2) + cd_loss_L1(pcd2_pred_path1, pcd2_pred_path2)
        loss_pcd1_path1 = cd_loss_L1(pcd1_pred_path1, pcd1_gt)
        loss_pcd2_path1 = cd_loss_L1(pcd2_pred_path1, pcd2_gt)
        loss_pcd1_path2 = cd_loss_L1(pcd1_pred_path2, pcd1_gt)
        loss_pcd2_path2 = cd_loss_L1(pcd2_pred_path2, pcd2_gt)
        loss_path1 = loss_pcd1_path1 + loss_pcd2_path1
        loss_path2 = loss_pcd1_path2 + loss_pcd2_path2
        total_loss = loss_path1 + loss_path2 + loss_consistency
        ...
        loss_dense, loss_medial_axis_surface, loss_medial_axis_interaction, loss_ibs_angle, intersect_num = get_evaluation_metrics(pcd_pred, pcd_gt, medial_axis_sphere)
...
def main_function(specs):
    ...
    train_loader, test_loader = get_dataloader(dataset_RBPCDC_single_norm.RBPCDCDataset, specs)
...
if __name__ == '__main__':
    ...
    arg_parser.add_argument(
        ...
        default="configs/INTE/train/specs_train_RBPCDC_single_norm_INTE.json",
        required=False,
