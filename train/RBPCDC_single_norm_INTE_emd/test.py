...
def get_evaluation_metrics(pcd_pred, pcd_gt, medial_axis_sphere):
    ...
    cd_l1_pcd1_path1 = l1_cd(pcd1_pred_path1, pcd1_gt)
    cd_l1_pcd1_path2 = l1_cd(pcd1_pred_path2, pcd1_gt)
    cd_l1_pcd2_path1 = l1_cd(pcd2_pred_path1, pcd2_gt)
    cd_l1_pcd2_path2 = l1_cd(pcd2_pred_path2, pcd2_gt)
    ...
    emd_pcd1_path1 = emd(pcd1_pred_path1, pcd1_gt)
    emd_pcd1_path2 = emd(pcd1_pred_path2, pcd1_gt)
    emd_pcd2_path1 = emd(pcd2_pred_path1, pcd2_gt)
    emd_pcd2_path2 = emd(pcd2_pred_path2, pcd2_gt)
    emd_pcd1 = (emd_pcd1_path1 + emd_pcd1_path2) / 2
    emd_pcd2 = (emd_pcd2_path1 + emd_pcd2_path2) / 2
    emd_ = torch.cat((emd_pcd1, emd_pcd2), dim=0)

    f_score_pcd1_path1 = f_score(pcd1_pred_path1, pcd1_gt)
    f_score_pcd1_path2 = f_score(pcd1_pred_path2, pcd1_gt)
    f_score_pcd2_path1 = f_score(pcd2_pred_path1, pcd2_gt)
    f_score_pcd2_path2 = f_score(pcd2_pred_path2, pcd2_gt)
    ...
    mas_pcd1_path1 = medial_axis_surface_dist(center1, radius1, pcd1_pred_path1)
    mas_pcd1_path2 = medial_axis_surface_dist(center1, radius1, pcd1_pred_path2)
    mas_pcd2_path1 = medial_axis_surface_dist(center2, radius2, pcd2_pred_path1)
    mas_pcd2_path2 = medial_axis_surface_dist(center2, radius2, pcd2_pred_path2)
    mas_pcd1 = (mas_pcd1_path1 + mas_pcd1_path2) / 2
    mas_pcd2 = (mas_pcd2_path1 + mas_pcd2_path2) / 2
    mas_ = torch.cat((mas_pcd1, mas_pcd2), dim=0)

    mai_pcd1_path1 = medial_axis_interaction_dist(center1, radius1, pcd1_pred_path1)
    mai_pcd1_path2 = medial_axis_interaction_dist(center1, radius1, pcd1_pred_path2)
    mai_pcd2_path1 = medial_axis_interaction_dist(center2, radius2, pcd2_pred_path1)
    mai_pcd2_path2 = medial_axis_interaction_dist(center2, radius2, pcd2_pred_path2)
...
def test(model, test_dataloader, specs):
    ...
    with torch.no_grad():
        for data, idx in test_dataloader:
            ...
            cd, emd_, fscore, mas, mai, ibss, interact_num = get_evaluation_metrics(pcd_pred, pcd_gt, medial_axis_sphere)
...
def main_function(specs):
    ...
    test_dataloader = get_dataloader(dataset_RBPCDC_single_norm.RBPCDCDataset, specs)
...
if __name__ == '__main__':
    ...
    arg_parser.add_argument(
        ...
        default="configs/INTE/test/specs_test_RBPCDC_single_norm_INTE.json",
        required=False,
