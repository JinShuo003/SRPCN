...
def train(network, train_dataloader, optimizer, epoch, specs, tensorboard_writer):
    ...
    for data, idx in train_dataloader:
        ...
        logger.info("loss_path1: {}".format(loss_path1.item()))
        logger.info("loss_path2: {}".format(loss_path2.item()))
        logger.info("loss_consistency: {}".format(loss_consistency.item()))
...
if __name__ == '__main__':
    ...
    arg_parser.add_argument(
        ...
        default="configs/INTE/train/specs_train_RBPCDC_single_norm_INTE_emd.json",
        required=False,
