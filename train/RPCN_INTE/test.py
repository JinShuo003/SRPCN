...
from models.RPCN import TopNet_path1, TopNet_path2
from utils.metric import *
from utils.test_utils import *
from utils import log_utils, path_utils, statistics_utils, geometry_utils
from dataset import dataset_RPCN
from dataset.dataset_RPCN import get_normalize_para_np
...
def main_function(specs):
    ...
    test_dataloader = get_dataloader(dataset_RPCN.RPCNDataset, specs)
