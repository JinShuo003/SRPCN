...
class App:
    ...
    def update_camera_all_scene(self):
        self.update_camera(self.scene_pcd_complete, self.pcd_complete)
        self.update_camera(self.scene_pcd_partial, self.pcd_partial)
        self.update_camera(self.scene_pcd_pred1, self.pcd_pred1)
        self.update_camera(self.scene_pcd_pred2, self.pcd_pred2)

    def update_camera(self, scene, geometry):
        if geometry is None:
            return
